...
import { SourceCreateInput, SourceUpdateInput } from '../../src/lib/services/source.service';
...
describe('SourceValidationService', () => {
  ...
  describe('validateSourceInput', () => {
    ...
    it('should validate correct input', async () => {
      await expect(service.validateSourceInput(validInput)).resolves.not.toThrow();
    });
    ...
    it('should validate input without optional fields', async () => {
      ...
      await expect(service.validateSourceInput(minimalInput)).resolves.not.toThrow();
    });
    ...
    it('should validate metadata with various value types', async () => {
      ...
      await expect(service.validateSourceInput(inputWithComplexMetadata)).resolves.not.toThrow();
    });
  });
  ...
  describe('validateSourceUpdate', () => {
    ...
    it('should validate correct update input', async () => {
      await expect(service.validateSourceUpdate(validUpdate)).resolves.not.toThrow();
    });
    ...
    it('should validate partial update', async () => {
      ...
      await expect(service.validateSourceUpdate(partialUpdate)).resolves.not.toThrow();
    });
    ...
    it('should validate empty update object', async () => {
      ...
      await expect(service.validateSourceUpdate(emptyUpdate)).resolves.not.toThrow();
    });
    ...
    it('should validate update with only metadata', async () => {
      ...
      await expect(service.validateSourceUpdate(metadataUpdate)).resolves.not.toThrow();
    });
  });
});
