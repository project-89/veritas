...
export const RSS_FEED_CATALOG: Record<string, RssFeedEntry[]> = {
  ...
  world_news: [
    ...
    { name: 'DW News', url: 'https://rss.dw.com/rdf/rss-en-all', category: 'world_news', tier: 1, language: 'en', region: 'global' },
    { name: 'NPR News', url: 'https://feeds.npr.org/1001/rss.xml', category: 'world_news', tier: 1, language: 'en', region: 'us' },
    { name: 'CBS News', url: 'https://www.cbsnews.com/latest/rss/main', category: 'world_news', tier: 2, language: 'en', region: 'us' },
    { name: 'ABC News International', url: 'https://abcnews.go.com/abcnews/internationalheadlines', category: 'world_news', tier: 2, language: 'en', region: 'us' },
  ...
  // ---------------------------------------------------------------------------
  us_politics: [
    { name: 'NPR - Politics', url: 'https://feeds.npr.org/1014/rss.xml', category: 'us_politics', tier: 1, language: 'en', region: 'us' },
  ...
  asia_pacific: [
    ...
    { name: 'Channel News Asia', url: 'https://www.channelnewsasia.com/api/v1/rss-outbound-feed?_format=xml', category: 'asia_pacific', tier: 1, language: 'en', region: 'singapore' },
    { name: 'Japan Times', url: 'https://www.japantimes.co.jp/feed/', category: 'asia_pacific', tier: 2, language: 'en', region: 'japan' },
    { name: 'Straits Times', url: 'https://www.straitstimes.com/news/asia/rss.xml', category: 'asia_pacific', tier: 2, language: 'en', region: 'singapore' },
    { name: 'Hindustan Times', url: 'https://www.hindustantimes.com/feeds/rss/india-news/rssfeed.xml', category: 'asia_pacific', tier: 2, language: 'en', region: 'india' },
  ...
  latin_america: [
    ...
    { name: 'Buenos Aires Times', url: 'https://www.batimes.com.ar/feed', category: 'latin_america', tier: 2, language: 'en', region: 'argentina' },
    { name: 'MercoPress', url: 'https://en.mercopress.com/rss', category: 'latin_america', tier: 2, language: 'en', region: 'latin_america' },
    { name: 'Brazil Wire', url: 'https://www.brasilwire.com/feed/', category: 'latin_america', tier: 3, language: 'en', region: 'brazil' },
    { name: 'Dialogo Americas', url: 'https://dialogo-americas.com/feed/', category: 'latin_america', tier: 3, language: 'en', region: 'latin_america' },
  ],
  ...
  // ---------------------------------------------------------------------------
  technology: [
    { name: 'TechCrunch', url: 'https://techcrunch.com/feed/', category: 'technology', tier: 1, language: 'en' },
    { name: 'The Verge', url: 'https://www.theverge.com/rss/index.xml', category: 'technology', tier: 1, language: 'en' },
    { name: 'Ars Technica', url: 'https://feeds.arstechnica.com/arstechnica/index', category: 'technology', tier: 1, language: 'en' },
    { name: 'Hacker News (Best)', url: 'https://hnrss.org/best', category: 'technology', tier: 1, language: 'en' },
    { name: 'MIT Technology Review', url: 'https://www.technologyreview.com/feed/', category: 'technology', tier: 1, language: 'en' },
    { name: 'Wired', url: 'https://www.wired.com/feed/rss', category: 'technology', tier: 1, language: 'en' },
    { name: 'ZDNet', url: 'https://www.zdnet.com/news/rss.xml', category: 'technology', tier: 2, language: 'en' },
    { name: 'Engadget', url: 'https://www.engadget.com/rss.xml', category: 'technology', tier: 2, language: 'en' },
  ...
  // ---------------------------------------------------------------------------
  finance: [
    { name: 'CNBC - Top News', url: 'https://search.cnbc.com/rs/search/combinedcms/view.xml?partnerId=wrss01&id=100003114', category: 'finance', tier: 1, language: 'en' },
    { name: 'CNBC - Finance', url: 'https://search.cnbc.com/rs/search/combinedcms/view.xml?partnerId=wrss01&id=10000664', category: 'finance', tier: 1, language: 'en' },
  ...
  // ---------------------------------------------------------------------------
  crypto: [
    { name: 'CoinDesk', url: 'https://www.coindesk.com/arc/outboundfeeds/rss/', category: 'crypto', tier: 1, language: 'en' },
  ...
  // ---------------------------------------------------------------------------
  science_health: [
    { name: 'Nature News', url: 'https://www.nature.com/nature.rss', category: 'science_health', tier: 1, language: 'en' },
    { name: 'Science Daily', url: 'https://www.sciencedaily.com/rss/all.xml', category: 'science_health', tier: 1, language: 'en' },
    { name: 'WHO - News', url: 'https://www.who.int/rss-feeds/news-english.xml', category: 'science_health', tier: 1, language: 'en' },
    { name: 'CDC - Newsroom', url: 'https://tools.cdc.gov/api/v2/resources/media/404952.rss', category: 'science_health', tier: 1, language: 'en', region: 'us' },
    { name: 'New Scientist', url: 'https://www.newscientist.com/feed/home/', category: 'science_health', tier: 1, language: 'en' },
  ...
  // ---------------------------------------------------------------------------
  energy: [
    { name: 'OilPrice.com', url: 'https://oilprice.com/rss/main', category: 'energy', tier: 1, language: 'en' },
...
export function getFeedsForQuery(query: string): RssFeedEntry[] {
  ...
  const keywordMap: Record<string, string[]> = {
    // US politics
    us_politics: [
      'congress', 'senate', 'house of representatives', 'democrat', 'republican',
      'gop', 'potus', 'president', 'white house', 'election', 'ballot',
      'supreme court', 'scotus', 'impeach', 'filibuster', 'legislation',
      'washington dc', 'capitol', 'biden', 'trump', 'us politics',
      'american politics', 'united states politic',
    ],
    // Europe
    europe: [
      'europe', 'european', 'eu ', 'brexit', 'nato', 'france', 'french',
      'germany', 'german', 'uk ', 'united kingdom', 'britain', 'british',
      'spain', 'spanish', 'italy', 'italian', 'poland', 'polish',
      'ukraine', 'ukrainian', 'russia', 'russian', 'sweden', 'norway',
      'denmark', 'netherlands', 'dutch', 'belgium', 'switzerland',
      'austria', 'portugal', 'greece', 'balkans', 'serbia', 'romania',
      'hungary', 'czech', 'slovakia', 'finland',
    ],
    // Middle East
    middle_east: [
      'middle east', 'mideast', 'israel', 'israeli', 'palestine', 'palestinian',
      'gaza', 'west bank', 'iran', 'iranian', 'iraq', 'iraqi', 'syria',
      'syrian', 'lebanon', 'lebanese', 'saudi', 'arabia', 'yemen', 'yemeni',
      'jordan', 'egypt', 'egyptian', 'turkey', 'turkish', 'kurdish', 'kurd',
      'hamas', 'hezbollah', 'houthi', 'gulf state', 'uae', 'dubai', 'qatar',
      'bahrain', 'oman', 'kuwait',
    ],
    // Asia Pacific
    asia_pacific: [
      'asia', 'asian', 'china', 'chinese', 'japan', 'japanese', 'korea',
      'korean', 'india', 'indian', 'pakistan', 'pakistani', 'taiwan',
      'taiwanese', 'philippines', 'filipino', 'vietnam', 'vietnamese',
      'indonesia', 'indonesian', 'malaysia', 'thai', 'thailand',
      'myanmar', 'burma', 'bangladesh', 'sri lanka', 'nepal',
      'australia', 'australian', 'new zealand', 'pacific', 'asean',
      'south china sea', 'xinjiang', 'tibet', 'hong kong', 'singapore',
      'cambodia', 'laos',
    ],
    // Africa
    africa: [
      'africa', 'african', 'nigeria', 'nigerian', 'kenya', 'kenyan',
      'ethiopia', 'ethiopian', 'south africa', 'congo', 'sudan', 'sudanese',
      'somalia', 'somali', 'mozambique', 'tanzania', 'uganda', 'ghana',
      'sahel', 'sahara', 'maghreb', 'morocco', 'algeria', 'tunisia',
      'libya', 'libyan', 'zimbabwe', 'angola', 'cameroon', 'senegal',
      'mali', 'niger', 'chad', 'burkina faso', 'rwanda',
    ],
    // Latin America
    latin_america: [
      'latin america', 'south america', 'central america', 'mexico',
      'mexican', 'brazil', 'brazilian', 'argentina', 'colombi',
      'venezuela', 'venezuelan', 'chile', 'chilean', 'peru', 'peruvian',
      'ecuador', 'bolivia', 'paraguay', 'uruguay', 'panama', 'costa rica',
      'guatemala', 'honduras', 'el salvador', 'caribbean', 'cuba', 'cuban',
      'haiti', 'dominican', 'puerto rico', 'cartel', 'narco',
    ],
    // Technology
    technology: [
      'tech', 'technology', 'software', 'hardware', 'ai ', 'artificial intelligence',
      'machine learning', 'deep learning', 'neural network', 'llm', 'gpt',
      'robot', 'automat', 'cyber', 'hack', 'silicon valley', 'startup',
      'app ', 'apple', 'google', 'microsoft', 'amazon', 'meta', 'facebook',
      'social media', 'internet', 'cloud', 'saas', 'semiconductor', 'chip',
      'quantum', 'vr ', 'virtual reality', 'augmented reality', 'ar ',
      'privacy', 'surveillance', 'encryption', 'data breach',
    ],
    // Finance
    finance: [
      'finance', 'financial', 'stock', 'market', 'wall street', 'economy',
      'economic', 'gdp', 'inflation', 'deflation', 'recession', 'interest rate',
      'fed ', 'federal reserve', 'central bank', 'monetary', 'fiscal',
      'bond', 'treasury', 'equity', 'invest', 'hedge fund', 'banking',
      'bank ', 'mortgage', 'credit', 'debt', 'trade war', 'tariff',
    ...
    crypto: [
      ...
      'defi', 'nft', 'token', 'web3', 'solana', 'cardano', 'altcoin',
      'stablecoin', 'usdt', 'usdc', 'binance', 'coinbase', 'mining',
      'wallet', 'ledger', 'metamask', 'dao ', 'dex ', 'cex ',
      'yield farm', 'staking', 'proof of', 'layer 2', 'l2 ',
      'lightning network', 'taproot', 'halving',
    ],
    // Defense & Intelligence
    defense_intel: [
      'defense', 'defence', 'military', 'army', 'navy', 'air force',
      'marine', 'pentagon', 'warfare', 'weapon', 'missile', 'nuclear weapon',
      'intelligence', 'espionage', 'spy', 'cia ', 'nsa ', 'mi6', 'mossad',
      'drone', 'uav', 'satellite', 'hypersonic', 'ballistic', 'conflict',
      'war ', 'invasion', 'occupation', 'insurgency', 'terrorist', 'terrorism',
      'counterterror', 'special forces', 'mercenary', 'wagner', 'arms deal',
      'sanction', 'geopolitic', 'nato ', 'alliance',
    ],
    // Science & Health
    science_health: [
      'science', 'scientific', 'research', 'study', 'health', 'medical',
      'medicine', 'disease', 'virus', 'vaccine', 'pandemic', 'epidemic',
      'covid', 'cancer', 'gene', 'genetic', 'dna', 'rna', 'protein',
      'climate', 'climate change', 'global warming', 'carbon', 'emission',
      'nasa', 'space', 'asteroid', 'planet', 'mars', 'moon', 'orbit',
      'physics', 'quantum', 'biology', 'chemistry', 'neuroscience',
      'brain', 'pharma', 'drug', 'fda ', 'who ', 'cdc ',
      'mental health', 'obesity', 'diabetes', 'heart', 'hospital',
    ],
    // Think Tanks
    think_tanks: [
      'think tank', 'policy analysis', 'foreign policy', 'geostrateg',
      'brookings', 'rand ', 'csis ', 'carnegie', 'heritage foundation',
      'cato institute', 'cfr ', 'council on foreign',
      'chatham house', 'atlantic council', 'wilson center',
      'international relations', 'diplomacy', 'diplomatic',
    ],
    // Energy
    energy: [
      'energy', 'oil', 'petroleum', 'gas ', 'natural gas', 'lng',
      'opec', 'crude', 'barrel', 'refinery', 'pipeline', 'fracking',
      'nuclear energy', 'nuclear power', 'reactor', 'uranium',
      'renewable', 'solar', 'wind power', 'wind energy', 'hydropower',
      'battery', 'lithium', 'ev ', 'electric vehicle', 'hydrogen',
      'grid', 'electricity', 'power plant', 'utility', 'coal',
      'carbon capture', 'emission', 'green energy', 'clean energy',
    ],
    // Government
    government: [
      'government', 'regulation', 'regulatory', 'legislation', 'law',
      'executive order', 'federal', 'state department', 'treasury',
      'sec ', 'securities', 'ftc ', 'antitrust', 'policy',
      'white house', 'congress', 'senate', 'parliament', 'eu commission',
  ...
  for (const category of matchedCategories) {
    ...
    for (const feed of feeds) {
      ...
      if (category === 'world_news' && !matchedCategories.has('world_news_explicit') && feed.tier !== 1) {
