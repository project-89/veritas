...
const variantStyles: Record<string, string> = {
  orange: 'bg-nerv-orange/22 text-nerv-orange border-nerv-orange/45 shadow-[0_0_12px_rgba(255,133,61,0.12)]',
  green: 'bg-nerv-green/20 text-nerv-green border-nerv-green/45 shadow-[0_0_12px_rgba(61,255,133,0.12)]',
  ...
  amber: 'bg-nerv-amber/22 text-nerv-amber border-nerv-amber/45 shadow-[0_0_12px_rgba(255,191,74,0.14)]',
  purple: 'bg-nerv-purple/22 text-nerv-purple border-nerv-purple/45 shadow-[0_0_12px_rgba(191,122,255,0.14)]',
